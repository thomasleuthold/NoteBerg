...
import { createNotebook, createNote } from '../modules/storage.js';
 ...
 */
export function showConfirmDialog(title, message, confirmText = 'Confirm', confirmClass = 'btn-danger') {
...
export function showCreateNotebookModal() {
  ...
  showModal('Create Notebook', content, async () => {
    ...
    window.dispatchEvent(new CustomEvent('datachange', { detail: { type: 'notebook', action: 'create', data: notebook } }));
  });
}
